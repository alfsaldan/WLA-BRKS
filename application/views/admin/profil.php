<div class="row mb-4">
    <div class="col-12 d-flex justify-content-between align-items-center">
        <div>
            <h3 class="mb-0 text-primary"><i class="bi bi-person-circle me-2"></i>Profil Admin</h3>
        ...
        <div class="card glass border-0 shadow-sm rounded-4 text-center p-4 h-100">
            <div class="position-relative d-inline-block mx-auto mb-3">
                ...
                $foto_url = (!empty($user->foto) && file_exists('./assets/img/profil/'.$user->foto)) 
                            ...
                            : 'https://ui-avatars.com/api/?name='.urlencode($user->nama).'&background=0d6efd&color=fff&size=150';
                ?>
            ...
            <span class="badge bg-primary rounded-pill px-3 py-2 mb-3"><i class="bi bi-shield-check me-1"></i> Administrator</span>
            
            <div class="text-start bg-light rounded-3 p-3 small mt-3">
                <div class="mb-2"><span class="text-muted d-block" style="font-size: 0.75rem;">Penempatan Cabang</span><span class="fw-bold"><?= htmlspecialchars($user->nama_cabang ?? 'Pusat / Akses Penuh') ?></span></div>
                <div class="mb-2"><span class="text-muted d-block" style="font-size: 0.75rem;">Unit Kerja</span><span class="fw-bold"><?= htmlspecialchars($user->nama_unit ?? 'Administrator') ?></span></div>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="modalUploadFoto" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered">
        <div class="modal-content glass border-0 shadow">
            ...
            <form action="<?= site_url('admin/profil/upload_foto') ?>" method="POST" enctype="multipart/form-data">
                <div class="modal-body text-center">
                    ...
                    <div class="form-text mt-2 small text-muted">Format: JPG/PNG. Maksimal 3MB. Rasio kotak (1:1) direkomendasikan.</div>
                </div>
